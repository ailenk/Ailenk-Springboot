package ink.bignose.knife4j.config;
...
public class Knife4jConfig {
    ...
    public Docket createRestApi1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此处添加需要扫描接口的包路径
                .apis(basePackage("ink.bignose.knife4j.test1controller" + SPLITOR
                        + "ink.bignose.knife4j.test2controller" + SPLITOR ))
    ...
    public Docket createRestApi2() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此处添加需要扫描接口的包路径
                .apis(basePackage("ink.bignose.knife4j.test3controller" + SPLITOR ))
                .paths(PathSelectors.any())
                .build();
    }
