package ink.bignose.multipledatasources.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "ink.bignose.multipledatasources.mapper.db2",sqlSessionTemplateRef ="twoSqlSessionTemplate")
public class DataSourceTwoConfig {
    ...
    public SqlSessionFactory twoSqlSessionFactory(@Qualifier("twoDS") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolver.getResources("classpath*:ink/bignose/multipledatasources/mapper/db2/xml/*.xml"));
