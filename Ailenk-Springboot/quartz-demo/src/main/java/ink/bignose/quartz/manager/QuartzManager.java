package ink.bignose.quartz.manager;

import ink.bignose.quartz.request.AddCronJobReq;
import ink.bignose.quartz.request.AddSimpleJobReq;
import ink.bignose.quartz.request.DeleteJobReq;
...
public class QuartzManager {
     ...
     * quartz任务类包路径
     */
    private static String jobUri = "ink.bignose.quartz.job.";
