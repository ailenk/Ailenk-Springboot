package ink.bignose.swagger.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此处添加需要扫描接口的包路径
                .apis(basePackage("ink.bignose.swagger.test1controller" + SPLITOR
                        + "ink.bignose.swagger.test2controller" + SPLITOR ))
    ...
    public Docket createRestApi2() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此处添加需要扫描接口的包路径
                .apis(basePackage("ink.bignose.swagger.test3controller" + SPLITOR ))
                .paths(PathSelectors.any())
                .build();
    }
